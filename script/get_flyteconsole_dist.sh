...
FLYTECONSOLE_IMAGE="472386928882.dkr.ecr.us-west-2.amazonaws.com/exa-labs/flyteconsole:${FLYTECONSOLE_VERSION:-v1.20.0}"
...
CONTAINER_ID=$(docker create 472386928882.dkr.ecr.us-west-2.amazonaws.com/exa-labs/flyteconsole:${FLYTECONSOLE_VERSION:-v1.20.0})
