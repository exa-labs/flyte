...
| flyte.flyteconsole.image.repository | string | `"472386928882.dkr.ecr.us-west-2.amazonaws.com/exa-labs/flyteconsole"` | Docker image for Flyteconsole deployment |
| flyte.flyteconsole.image.tag | string | `"latest"` | Docker image tag |
