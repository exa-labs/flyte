...
func (cfg Config) GetPFlagSet(prefix string) *pflag.FlagSet {
	...
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "userAuth.cookieSetting.maxAge"), DefaultConfig.UserAuth.CookieSetting.MaxAge.String(), "OPTIONAL: Sets the max age of auth cookies. If unset,  cookies are session cookies and may be cleared by the browser at any time.")
